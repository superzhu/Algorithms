...
/**
 * EPI Problem 11.1 : Design an algorithm that takes a set of files containing stock trades
 * sorted by increasing trade times, and writes a single file containing the trades appearing
 * in the individual files sorted in the same order. The algorithm should use very little RAM,
