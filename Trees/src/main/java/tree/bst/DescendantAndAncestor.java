 ...
 * Let r,s,and m be distinct nodes in a BST. In this BST,
 * nodes do not have pointers to their parents and all
 * keys are unique. Write a function which return true
 * if m has both an ancestor and a descendant in the set
 * {r,s}.
 */
