...
public class NumToString {
    ...
    public static void main(String[] args) {
		...
		*//* numbers between 0 and 100 *//*
        for (int i = 0; i < 10; i++) {
            int value = 9;//AssortedMethods.randomIntInRange(0, 100);
		...
		*//* numbers between 100 and 1000 *//*
        for (int i = 0; i < 10; i++) {
            int value = 35;// AssortedMethods.randomIntInRange(100, 1000);
            String s = numToString(value);
            System.out.println(value + ": " + s);
        }
		...
		*//* numbers between 1000 and 100000 *//*
        for (int i = 0; i < 10; i++) {
            int value = 1089;//AssortedMethods.randomIntInRange(1000, 100000);
            String s = numToString(value);
            System.out.println(value + ": " + s);
        }
		...
		*//* numbers between 100000 and 100000000 *//*
        for (int i = 0; i < 10; i++) {
            int value = 67888;//AssortedMethods.randomIntInRange(100000, 100000000);
            String s = numToString(value);
            System.out.println(value + ": " + s);
        }
		...
		*//* numbers between 100000000 and 1000000000 *//*
        for (int i = 0; i < 10; i++) {
            int value = 998866;//AssortedMethods.randomIntInRange(100000000, 1000000000);
            String s = numToString(value);
            System.out.println(value + ": " + s);
        }
		...
		*//* numbers between 1000000000 and Integer.MAX_VALUE *//*
        for (int i = 0; i < 10; i++) {
            int value = 9013334;//AssortedMethods.randomIntInRange(1000000000, Integer.MAX_VALUE);
            String s = numToString(value);
            System.out.println(value + ": " + s);
        }*/
