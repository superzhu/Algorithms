...
/**
 * 16.2 Give a dictionary D and two strings s and t, write a function
 * to determine if s produces t. Assume that all characters are lowercase
 * alphabets. If s does produce t, output the length of a shortest production
